...
public:
    SDT_Function() : VectorFunction("sdt", 2), scalers_loaded(false)
    {
        ...
        scaling_path = "/home/jovyan/project/models/sdt.jnnx/build/sdt_emulator_scaling.txt";
    ...
    {
        // Check input bounds (optional - neural networks can handle out-of-bounds inputs)
                  ...
                  std::vector<unsigned int> const &lengths) const
    {
        try {
            ...
            std::vector<float> input_scaled(2);
            for (unsigned int i = 0; i < 2; ++i) {
